...
def fesi(fd):
    ...
    mask = skimage.filters.median(mask,morphology.disk(1)) + 100 #model1
    #mask = skimage.filters.median(mask,morphology.disk(7)) + 100
    mask = tr12(mask,mask.min())

    mask = morphology.binary_opening(mask,morphology.disk(3)) #mpdel1
...
for i in range(1,11):
    im = Image.open("/Users/vladimirlisovoi/desktop/учеба/diplom/dtmsu/{0}W.png".format(i))
    data = np.array(im)
    ...
    omg.show()
    omg.save("/Users/vladimirlisovoi/desktop/учеба/diplom/dtmsu/out{0}.png".format(i))
...
omg = Image.fromarray(fd)
omg.show()
omg.save("/Users/vladimirlisovoi/desktop/учеба/diplom/dtmsu/out05.png")'''
